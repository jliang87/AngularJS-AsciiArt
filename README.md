...
When I saw the project description, my first reaction was to take up the challenge to learn the basics of AngularJS in a week to build my first AngularJS app, since I can learn something new and 'in', and it seems more fun. 
